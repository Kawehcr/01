"""
Django urls for inventoryvitin project.

Generated by 'kawe-henrique'
date_create: 16/02/2023

this urls file is a set of patterns that Django will use to compare against the incoming URL to find the correct answer.
...
urlpatterns = [
    ...
    path(
        "api/v1/Vitins/<int:pk>/retrieve",
        VitinRetrieveUpdateDeleteViewSet.as_view(),
        name="Vitin_retrieve",
    ),
    path(
        "api/v1/Vitins/<int:pk>/update",
        VitinRetrieveUpdateDeleteViewSet.as_view(),
        name="Vitin_update",
    ),
    path(
        "api/v1/Vitins/<int:pk>/destroy",
        VitinRetrieveUpdateDeleteViewSet.as_view(),
        name="Vitin_destroy",
    ),
